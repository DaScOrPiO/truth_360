document.addEventListener("DOMContentLoaded", function () {
  ...
  let currentPage = 1;
  let initialDisplay = topRated.length;
    ...
    try {
      if (initialDisplay < totalItems) {
        ...
        <button
          ...
          data-bs-target="#topRated-review-modal${initialDisplay + i}"
        ...
        <div
          class="modal fade"
          id="topRated-review-modal${initialDisplay + i}"
          tabindex="-1"
                ...
                <form>
                  ...
                  <div class="mb-3">
                    <fieldset class="starability-grow">
                      ...
                      <input
                        type="radio"
                        id="topRated-no-rate${initialDisplay + i}"
                        class="input-no-rate"
                        name="rating"
                        value="1"
                      ...
                      <input
                        type="radio"
                        id="topRated-rate1${initialDisplay + i}"
                        name="rating"
                        value="1"
                        checked
                      />
                      <label for="topRated-rate1${initialDisplay + i}">1 star.</label>

                      <input
                        type="radio"
                        id="topRated-rate2${initialDisplay + i}"
                        name="rating"
                        value="2"
                      />
                      <label for="topRated-rate2${initialDisplay + i}">2 stars.</label>

                      <input
                        type="radio"
                        id="topRated-rate3${initialDisplay + i}"
                        name="rating"
                        value="3"
                      />
                      <label for="topRated-rate3${initialDisplay + i}">3 stars.</label>

                      <input
                        type="radio"
                        id="topRated-rate4${initialDisplay + i}"
                        name="rating"
                        value="4"
                      />
                      <label for="topRated-rate4${initialDisplay + i}">4 stars.</label>

                      <input
                        type="radio"
                        id="topRated-rate5${initialDisplay + i}"
                        name="rating"
                        value="5"
                      />
                      <label for="topRated-rate5${initialDisplay + i}">5 stars.</label>
